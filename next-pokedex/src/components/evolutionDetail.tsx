      ...
      <div className='flex flex-col items-center'>
        ...
        */} 
        ...
        {/*child[0].　　　自分の次が分岐（isBranching）の時　※ラルトス
          自分をcolで出し、※1匹目と同じ
          次をmapでだしてrow並べ（※進化条件あり）
        */} 

        {child[0].isBranching && (
        <div> 
          <div className='flex flex-col items-center bg-emerald-700' key={child[0].prof.id}>
            <div className='flex flex-col items-center'>
              <div className=' bg-fuchsia-800 mb-5 text-blue-200'>
                <ChevronsDown size={40} />
              </div>
